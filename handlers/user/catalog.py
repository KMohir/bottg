...
async def add_product_callback_handler(query: CallbackQuery, callback_data: dict):
    ...
    await query.answer("Товар добавлен в корзину можете зайти в корзину и оформить заказ!")
...
async def show_products(m, products):
    ...
    if len(products) == 0:
        ...
        await m.answer("Вы добавили все товары в корзинку можете зайти в корзину и оформить заказ")
